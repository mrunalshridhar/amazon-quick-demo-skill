...
- **Mode**: `agentic`
- **Tools**: `file_write`
- **Prerequisite**: Step 17b (Pre-Write File Safety Check) MUST have been executed first.
  If shared-name files existed, they have already been renamed to preserve previous demo versions.
